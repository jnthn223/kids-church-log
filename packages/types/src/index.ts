...
export interface ServiceSession { id: string; localServiceDate: string; scheduleId: string; scheduleName: string; scheduleStartTime?: string; sessionKind?: "SCHEDULED" | "ON_DEMAND"; status: "DRAFT" | "OPEN" | "CLOSED" | "CANCELLED"; openedAt?: unknown; openedBy?: string; closedAt?: unknown; closedBy?: string; stationName?: string; revision?: number; roomMappingUpdatedAt?: unknown; roomMappingUpdatedBy?: string; }
...
export interface VolunteerAssignment { id: string; memberUid: string; displayName: string; roomId?: string; groupId?: string; servingAreaLabel?: string; assignmentRole: string; active: boolean; joinedAt?: unknown; joinedBy?: string; assignmentUpdatedAt?: unknown; assignmentUpdatedBy?: string; }
...
export interface Attendance { id: string; childId: string; childNameSnapshot: string; householdId: string; householdNameSnapshot: string; sessionId: string; scheduleId?: string; scheduleNameSnapshot?: string; localServiceDate?: string; groupId: string; groupNameSnapshot: string; roomId: string; roomNameSnapshot: string; registeredGroupId?: string; placementOverridden?: boolean; placementOverrideReason?: string; status: "CHECKED_IN" | "CHECKED_OUT"; checkInAt?: unknown; checkInBy?: string; checkInMethod?: "QR" | "MANUAL" | "NFC"; checkOutAt?: unknown; checkOutBy?: string; checkOutMethod?: "QR" | "MANUAL" | "NFC"; releasedToGuardianId?: string; releasedToName?: string; checkoutNote?: string; roomChangedAt?: unknown; roomChangedBy?: string; roomChangeReason?: string; }
