...
export default function AttendancePage() {
  ...
  const rows = attendance.filter((item) => `${item.childNameSnapshot} ${item.householdNameSnapshot} ${item.roomNameSnapshot}`.toLocaleLowerCase().includes(term.toLocaleLowerCase())).sort((a, b) => a.childNameSnapshot.localeCompare(b.childNameSnapshot));
